...
const viewsOnUrl = async (req, res) => {
  try {
    ...
    if (!existingUrl) {
      return res
        .status(404)
        .send(new ApiResponse(404, null, "fields are empty"));
    }

    // console.log(existingUrl.clicks)
    // const result=existingUrl.clicks
    ...
    res
      .status(500)
      .send(new ApiResponse(500, error, "Cannot find views for this url"));
  }
};
